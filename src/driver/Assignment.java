...
//    public static ListInterface<DeliveryMan> manList = new List<>();
    ...
    public Assignment() {
        ...
        DeliveryMan deliMan = new DeliveryMan(10, "Miw", "Miw12345", "012-3456789", "Jalan Miw", "Employed", null, "Unavailable", "", 0, 0.0, 2.0, 10);
        DeliveryMan deliMan1 = new DeliveryMan(20, "Albert", "1234", "012-8723124", "Jalan Pisang", "Employed", null, "Available", "", 0, 0.0, 3.0, 10);
        DeliveryMan deliMan2 = new DeliveryMan(30, "Thomas", "1234", "012-8132234", "Jalan Rambutan", "Employed", null, "Unavailable", "", 0, 0.0, 3.0, 10);
        DeliveryMan deliMan3 = new DeliveryMan(40, "Jack", "1234", "012-8132234", "Jalan Rambutan", "Employed", null, "Unavailable", "", 0, 0.0, 2.0, 10);
        DeliveryMan deliMan4 = new DeliveryMan(40, "Kelvin", "1234", "012-8134234", "Jalan Rambutan", "Employed", null, "Available", "", 0, 0.0, 0.0, 0);
...
//                        dm.setRating(randomRating);
    ...
    public static void addDeliveryMan() {
        ...
        do {
            ...
            deliMan1.setWorkingStatus("Unavailable");
            deliMan1.setOrderCharge("");
...
//ModuleA
    ...
    public void deleteFood() {
        ...
        for (int i = 1; i <= food.getSize(); i++) {
            if (foodID.equals(food.getAtPosition(i).getFoodID()) && curAffiliate.getRes_id().equals(food.getAtPosition(i).getRestaurant().getRes_id())/**
                     * &&
                     * affiliate.getEntry(idIndex).equals(food.getEntry(i).getRestaurant())*
                     */
                    ) {
    ...
    public void viewDelivery() {
        ...
        System.out.println("====================================================================================================");
        for (int i = 1; i <= manList.getLength(); i++) {
            if (manList.getEntry(i).getWorkingStatus().equals("Available")) {
                ...
                if (deliverOrder.equals(orderList.getEntry(a).getOrderId())) {
                    ...
                    for (int i = 1; i <= manList.getLength(); i++) {
                        if (deliverDeliveryMan == manList.getEntry(i).getManID()) {
                            ...
                            if (manList.getEntry(i).getMaxDelivery() == 3 || manList.getEntry(i).getWorkingStatus().equalsIgnoreCase("Unavailable") || manList.getEntry(i).getOrderCharge().equals(deliverOrder)) {
